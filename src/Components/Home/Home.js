                  ...
                  <div className="container">
                     ...
                     <Education/>
                          ...
                          <div className="row">
                            ...
                            <ScrollAnimation animateIn='fadeIn'><h5>Practice diligently for FREE</h5></ScrollAnimation>
                            <ScrollAnimation animateIn='fadeIn'><h4>ARE YOU PREPARED FOR EXAM DAY? PUT YOUR KNOWLEDGE TO TEST</h4></ScrollAnimation>
                            <Link to='/exam'> <ScrollAnimation animateIn='fadeIn'><span className="btn btn-right btn-light">Take Test</span></ScrollAnimation></Link>
                            </div>
                         ...
                         <div  className="col-sm-10 col-md-4">
                            <div  style={{alignItems:'center' ,padding:"60px 3px 10px 3px"}} className="card text-center">
                                ...
                                <Link style={{textDecoration:'none'}} to='/exam'>
                                  <div className="card-body">
                                    <h5 style={{fontWeight:'bolder' ,color:'rgba(0,0,0,0.5)', fontSize:'20px' , opacity:'0.8'}} className="card-title">ENGLISH LANGUAGE</h5>
                            ...
                            <div style={{alignItems:'center', padding:"60px 3px 10px 3px"}} className="card text-center">
                                ...
                                <Link style={{textDecoration:'none'}} to='/exam'>
                                  <div  className="card-body">
                                    <h5 style={{fontWeight:'bolder' ,color:'rgba(0,0,0,0.5)', fontSize:'20px' , opacity:'0.8'}} className="card-title">MATHEMATICS</h5>
                            ...
                            <div style={{alignItems:'center', padding:"60px 3px 10px 3px"}} className="card text-center">
                                ...
                                <Link style={{textDecoration:'none'}} to='/exam'>
                                  <div className="card-body">
                                    <h5 style={{fontWeight:'bolder',color:'rgba(0,0,0,0.5)' , fontSize:'20px' , opacity:'0.8'}} className="card-title">CHEMISTRY</h5>
                         ...
                         <div className="col-sm-10 col-md-4">
                            <div style={{alignItems:'center', padding:"60px 3px 10px 3px"}} className="card text-center">
                                ...
                                <Link style={{textDecoration:'none'}} to='/exam'>
                                  <div className="card-body">
                                    <h5 style={{fontWeight:'bolder',color:'rgba(0,0,0,0.5)' , fontSize:'20px' , opacity:'0.8'}} className="card-title">PHYSICS</h5>
                            ...
                            <div style={{alignItems:'center', padding:"60px 3px 10px 3px"}} className="card text-center">
                                ...
                                <Link style={{textDecoration:'none'}} to='/exam'>
                                  <div className="card-body">
                                    <h5 style={{fontWeight:'bolder',color:'rgba(0,0,0,0.5)' , fontSize:'20px' , opacity:'0.8'}} className="card-title">BIOLOGY</h5>
                            ...
                            <div className="col-sm-10 col-md-4">
                              <div style={{alignItems:'center', padding:"60px 3px 10px 3px"}} className="card text-center">
                                  ...
                                  <Link style={{textDecoration:'none'}} to='/exam'>
                                  <div className="card-body">
                                    <h5 style={{fontWeight:'bolder', color:'rgba(0,0,0,0.5)' , fontSize:'20px' , opacity:'0.8'}} className="card-title">COMMERCE</h5>
                          ...
                          <div className="row">
                            ...
                            <Link to='/exam' style={{color:'white'}}>
                              View More
                              </Link>
                            </div>
