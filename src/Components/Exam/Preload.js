           ...
           <React.Fragment>
               <div className="row pre">
                   <div style={{backgroundColor:'white',borderRadius:'7px', padding:'50px'}} className="inner_ mx-auto   col-md-8  col-sm-10">
                     ...
                     <h4 className="text-primary text-center">{this.props.subject} UTME Practice Question.</h4>
                     <p style={{fontSize:'17px', lineHeight:'1.5em'}} className="my-4 text-center text-secondary">
                       In Preparation of the upcoming UTME examination.<br/>
                       We have decided to help students come out with excellent result.
                     </p>
                     <p style={{fontSize:'17px', lineHeight:'1.5em'}} className="my-4 text-center text-secondary">
                      We therefore are going to give everyone<br/>
                      the opportunity to practice questions based on different topics<br/>
                      that will be updated frequently.

                     </p>
                     <p style={{fontSize:'17px', lineHeight:'1.5em'}} className="my-4 text-center text-secondary">
                      Do make sure you check here for latest update.
                     </p>
